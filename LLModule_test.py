...
class LLProducer(Module):
    ...
    def analyze(self, event):
        ...
        if self.runJEC:
            ...
            """
            print "H_pt_nom:",self.H_pt_nom
            print "H_pt_jesUp:",self.H_pt_jesUp
            print "H_pt_jesDown:",self.H_pt_jesDown
            print "H_pt_jerUp:",self.H_pt_jerUp
            print "H_pt_jerDown:",self.H_pt_jerDown
            print "PuppiMET_pt_nom:",self.PuppiMET_pt_nom
            print "PuppiMET_pt_jesUp:",self.PuppiMET_pt_jesUp
            print "PuppiMET_pt_jesDown:",self.PuppiMET_pt_jesDown
            print "PuppiMET_pt_jerUp:",self.PuppiMET_pt_jerUp
            print "PuppiMET_pt_jerDown:",self.PuppiMET_pt_jerDown
            """
        ...
        if self.runJEC:
            ...
            """
            print "X_mass_MET_nom:",self.X_mass_MET_nom
            print "X_mass_MET_jesUp:",self.X_mass_MET_jesUp
            print "X_mass_MET_jesDown:",self.X_mass_MET_jesDown
            print "X_mass_MET_jerUp:",self.X_mass_MET_jerUp
            print "X_mass_MET_jerDown:",self.X_mass_MET_jerDown
            """
        self.V_pt  = V.Pt()
        self.V_eta = V.Eta()
        self.V_phi = V.Phi()
